...
if __name__ == '__main__':
    ...
    for epoch in range(last_epoch, max_epochs):
        ...
        for i, (real_img, real_c) in enumerate(dataloader, str_i):
            ...
            # Calculate D loss
            loss_real = criterion(net_D(real_img, real_c_one_hot), ones)  # loss of real batch
            loss_fake = criterion(net_D(fake_img.detach(), fake_c_one_hot.detach()), zeros)  # loss of fake batch
            ...
            loss_G = criterion(net_D(fake_img, fake_c_one_hot), ones)
